    ...
    <div className="bg-img">
      <div className="navbar pb-16 md:flex items-center bg-blue-400/70">
        <div className="navbar-start mt-0">
          ...
          <img
            className="md:w-56 md:h-36 w-36 h-28 absolute md:top-6 md:left-6 left-1/2 top-16 transform -translate-x-1/2 -translate-y-1/2 md:translate-x-0 md:translate-y-0"
            src={logo}
            alt=""
          />
        </div>
